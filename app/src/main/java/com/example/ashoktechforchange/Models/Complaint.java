...
public class Complaint {
    ...
    public Complaint(String officerName, String officerComment, String name, String uid, String department, String description,
                     String location, int status, String date, String videoUrl, String latLong, String officer, int likes,
                     String compID, String time, String tag, String isFirstComplaint) {
        this.officerName = officerName;
        this.officerComment = officerComment;
        this.name = name;
        this.uid = uid;
